...
class CMSUser(db.Model):
    ...
    id = db.Column(db.Integer,primary_key=True,autoincrement=True)
    username = db.Column(db.String(500),nullable=False)   #不能为空
    _password = db.Column(db.String(1000),nullable=False)
    email = db.Column(db.String(500),nullable=False,unique=True)    #不能重复
